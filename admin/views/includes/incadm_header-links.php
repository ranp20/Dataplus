...
$url = $actual_link . "/Dataplus/admin/views/";
$urlCli = $actual_link . "/Dataplus/";
...
<meta property="og:image" name="twitter.image" content="./views/assets/img/logos/dataplus-favicon.png"/>
<link rel="icon" type="image/x-icon" href="./views/assets/img/favicon/dataplus-favicon.png"/>
<link rel="apple-touch-icon" href="./views/assets/img/favicon/dataplus-favicon.png"/>
