...
$(document).on("submit", "#logg-cPlatformAdm", function(e){
  e.preventDefault();
  ...
  $.ajax({
    ...
    if(e != "" && e != "[]"){
      ...
      if(r.r == "true"){
      ...
      }else if(r.r == "err_email"){
        $('#logg-cPlatformAdm')[0].reset();
        ...
        $("#cMessage-user").html(`<div id="msgAlertLoginErr">
          <div class="msgAlertLoginErr--c">
            ...
            <h3 class="msgAlertLoginErr--c--title">¡Correo Inválido!</h3>
            <p class="msgAlertLoginErr--c--desc">El correo electrónico ingresado no es válido.</p>
          </div>
        </div>`);
        $(this).find("button[type=submit]").removeClass("showActive");
        setTimeout(function(){$('#msgAlertLoginErr').addClass('disabled');}, 4500);
        ...
        document.querySelector("#btnCloseErr").addEventListener("click", function(){document.querySelector("#msgAlertLoginErr").classList.add("disabled");});
      }else{
        $("#cMessage-user").html(`<div id="msgAlertLoginErr">
          <div class="msgAlertLoginErr--c">
            <span class="msgAlertLoginErr--c--close" id="btnCloseErr"></span>
      ...
      $("#cMessage-user").html(`<div id="msgAlertLoginErr">
        <div class="msgAlertLoginErr--c">
          <span class="msgAlertLoginErr--c--close" id="btnCloseErr"></span>
          <h3 class="msgAlertLoginErr--c--title">¡Error!</h3>
          <p class="msgAlertLoginErr--c--desc">Lo sentimos, hubo un error al procesar la información.</p>
        </div>
      </div>`);
      $(this).find("button[type=submit]").removeClass("showActive");
      setTimeout(function(){$('#msgAlertLoginErr').addClass('disabled');}, 4500);
